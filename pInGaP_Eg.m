function [Eg, ni, mu, meeff,mheff erel]=pInGaP_Eg(GaInP_comp, N, T)
%% Constants
kb=1.381e-23;%J/K
...
mu=muminn*Tn^(-.57)+((mumaxn-muminn)*Tn^(-2.3))/(1+(N/(Nrefn*Tn^(-2.4)))^(chi*Tn^(-.146))); %InGaP window  (minority electrons in ptype)
